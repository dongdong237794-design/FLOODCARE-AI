...
def ask_gemini_with_search(question: str, max_tokens: int = 700) -> dict:
    ...
    try:
        ...
        try:
            ...
            if grounding:
                for chunk in getattr(grounding, "search_entry_point", []):
                    # In newer SDK, search grounding structure might differ
                    pass
                # Simplified approach for newer SDK
            ...
            Logger.error("Gemini", f"Grounding extraction failed: {ge}")
