...
class IntentClassifier:
    ...
    def classify(cls, text: str) -> Tuple[str, float]:
        ...
        # ✅ ตรวจ EMERGENCY และ SOS ก่อนเสมอ (priority override)
        PRIORITY_INTENTS = ["EMERGENCY", "SOS"]
...
def init_gemini():
    ...
    try:
        ...
        gemini_model = genai.GenerativeModel(
            ...
            system_instruction=(
                "คุณคือ FLOODCARE AI ผู้ช่วยกู้ภัยมืออาชีพ\n"
                "[1] Emergency First: ตรวจจับคำสำคัญ ช่วยด้วย/จม/ไฟดูด → ส่งขั้นตอนเอาตัวรอด + เบอร์ 1784\n"
                "[2] Data-Driven: ใช้ข้อมูลระบบเป็นหลัก หากไม่มีให้บอก 'ไม่มีข้อมูล'\n"
                "[3] Tone: ใจดีแต่เด็ดขาด เป็นขั้นตอน 1-2-3\n"
                "[4] Format: 3 บรรทัดแรกสำคัญสุด ไม่เกิน 10 บรรทัดต่อกลุ่ม\n"
                "[5] Safety: ห้ามเดาข้อมูล ห้ามยืนยันความปลอดภัย 100%\n"
                "[6] Language: ภาษาไทยเป็นหลัก"
            )
        )
        _gemini_initialized = True
