...
def _handle_ai_query(event, user_id, user_text, timestamp):
    ...
    ai_response = ask_gemini(
        "ก่อนตอบ ให้เช็คก่อนว่าคำถามนี้เกี่ยวกับน้ำท่วม ภัยพิบัติ ความปลอดภัย การปฐมพยาบาล "
        "สภาพอากาศ ที่พักพิง หรือการขอความช่วยเหลือหรือไม่ ถ้าไม่เกี่ยวข้องเลย ให้ปฏิเสธตามที่ระบุไว้ใน "
        "system instruction ข้อ [7] เท่านั้น อย่าตอบคำถามนอกเรื่อง\n\n"
        "ถ้าเกี่ยวข้อง ให้ตอบคำถามนี้ให้ครบถ้วน ชัดเจน เข้าใจง่าย ใช้ภาษาที่คนทั่วไปอ่านแล้วเข้าใจทันที "
